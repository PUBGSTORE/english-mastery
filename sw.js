...
const VERSION = 'em-v2.0.2';
const SHELL = [
  './', './index.html', './manifest.webmanifest',
  './css/theme.css', './css/app.css',
  './js/app.js', './js/router.js', './js/db.js', './js/srs.js', './js/store.js', './js/content.js', './js/ui.js', './js/utils.js',
  './js/i18n.js', './js/sync.js', './js/lemma.js', './js/lemmas.js', './js/mine.js', './js/youtube.js', './js/generate.js', './js/session.js', './js/pitch.js', './js/search.js', './js/weaksounds.js', './js/tts.js', './js/asr.js', './js/audio.js', './js/ai.js', './js/charts.js', './js/exercise.js',
