...
const SHELL = [
  ...
  './js/views/chat.js', './js/views/notes.js', './js/views/mistakes.js', './js/views/progress.js', './js/views/placement.js', './js/views/settings.js',
...
const DATA = [
  ...
  'writing-prompts', 'speaking-prompts', 'placement',
].map((n) => `./data/${n}.json`);
